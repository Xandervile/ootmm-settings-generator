        ...
        if SoulShuffle == "Enemy" or SoulShuffle == "Full":
            ...
            if data["SharedItems"][0] == True:
                HintList.insert(HintIndex, {"type": "item",
                                            "amount": 1,
                                            "extra": 1,
                                            "item": "SHARED_SOUL_ENEMY_LIZALFOS_DINOLFOS"})
                HintList.insert(HintIndex, {"type": "item",
                                            "amount": 1,
                                            "extra": 1,
                ...
                HintList.insert(HintIndex, {"type": "item",
                                            "amount": 1,
                                            "extra": 0,
                                            "item": "OOT_SOUL_ENEMY_LIZALFOS_DINOLFOS"})
                HintList.insert(HintIndex, {"type": "item",
                                            "amount": 1,
                                            "extra": 0,
                ...
                HintList.insert(HintIndex, {"type": "item",
                                            "amount": 1,
                                            "extra": 0,
                                            "item": "MM_SOUL_ENEMY_LIZALFOS_DINOLFOS"})
                HintList.insert(HintIndex, {"type": "item",
                                            "amount": 1,
                                            "extra": 0,
    ...
    if SongShuffle == "Mixed with Owls":
        ...
        if SharedMQDungeons > 0:
            if "IC" in MQDungeonChosen:
                SongAndOwlLocation.append("OOT MQ Ice Cavern Sheik Song")
                SongAndOwlLocation.remove("OOT Ice Cavern Sheik Song")
        if data["SharedItems"][0] == False:
